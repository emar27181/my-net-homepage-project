...
const COLOR_MAP = {
  ...
  pink: { hex: 'var(--col-primary)', rgba: 'var(--col-primary-rgb, 77, 121, 255)' },
  purple: { hex: 'var(--col-primary)', rgba: 'var(--col-primary-rgb, 77, 121, 255)' },
  lime: { hex: '#32ff32', rgba: '50, 255, 50' },
  blue: { hex: 'var(--col-primary)', rgba: 'var(--col-primary-rgb, 77, 121, 255)' },
